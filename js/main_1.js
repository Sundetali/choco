$(document).ready(function() {
	...
	$('.btn-ref-non').click(function() {
		...
		//remove in each click event then add non-refundable tax
		$('.result-tax option').remove();
		$.each($('.tax-select'), function(){

			if($(this).val() == 'non-refundable') {
				console.log($(this).val());
				$('.result-tax').append("<option value="+$(this).attr('name')+">"+$(this).attr('name')+"</option>");
			}
		});
