$(document).ready(function() {
			...
			var sum_penalty = parseInt($('.sum_penalty').text());
			var sum_without_tax = parseInt($('.without_tax').text());
			var per = Math.ceil((sum_penalty/sum_without_tax) * 100);
			$('.percentage-val').val(per);
