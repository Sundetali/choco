...
<body>
	...
	<?php if(isset($send_to_superviser) && !$send_to_superviser == TRUE):?>
		<div class="send-result d-flex flex-column">
		<span class="dif">You send data to supervise succesfully</span>
		<a href="senddata.php">go to main page</a>
		</div>
	<?php else: ?>
